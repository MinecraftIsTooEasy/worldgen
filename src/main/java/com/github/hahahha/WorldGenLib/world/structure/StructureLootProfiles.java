...
public final class StructureLootProfiles {
    ...
    public static int getLevelForMarker(ItemStack markerStack, StructureLootProfile profile) {
        ...
        return getLevelForMarker(markerStack.itemID, profile);
    }

    public static int getLevelForMarker(int markerItemId, StructureLootProfile profile) {
        if (markerItemId <= 0) {
            return 0;
        }
        StructureLootProfile safeProfile = profile == null ? DEFAULT_PROFILE : profile;
        Integer level = safeProfile.markerLevelOf(markerItemId);
    ...
    public static final class Builder {
        ...
        private final Map<Integer, Integer> markerLevels = new LinkedHashMap<Integer, Integer>(8);
        private final Map<Integer, StructureLootProfile.LootLevel> levels =
                new LinkedHashMap<Integer, StructureLootProfile.LootLevel>(8);
        ...
        public Builder marker(int itemId, int level) {
            ...
            this.markerLevels.put(itemId, level);
            return this;
        }
