...
public final class StructureLootApi {
    ...
    public static WeightedRandomChestContent entry(
            ...
            int maxCount,
            int weight) {
        return entry(resolveItemId(itemName), meta, minCount, maxCount, weight);
    }
    ...
    public static final class LootProfileBuilder {
        ...
        public LootProfileBuilder marker(String itemName, int level) {
            this.delegate.marker(StructureLootApi.resolveItemId(itemName), level);
            return this;
        }
